...
export const projectRevenueChartData = [
  { name: "Development", actual: 82000, target: 90000 },
  { name: "Consultation", actual: 48000, target: 65000 },
  { name: "Framer Sites", actual: 34000, target: 45000 },
  { name: "Client Support", actual: 77000, target: 90000 },
  { name: "Personnal Training", actual: 68000, target: 80000 },
...
export const actionItems = [
  {
    id: 1,
    title: "Envoyer les documents de démarrage",
    desc: "Envoyer les documents d'onboarding et le calendrier",
    due: "À faire aujourd’hui",
    priority: "Haute",
  ...
  {
    id: 2,
    title: "Appel démo pour le MVP SaaS",
    desc: "Planifier un appel Zoom avec le client",
    due: "À faire demain",
    priority: "Moyenne",
  ...
  {
    id: 3,
    title: "Mettre à jour l’étude de cas",
    desc: "Ajouter le dernier projet de boutique en ligne",
    due: "À faire cette semaine",
    priority: "Faible",
