...
type RoleFormDataDialogProps = {
  onCreate: (RoleData: RoleFormData) => void;
}

export const AddRoleDialog = ({ onCreate }: RoleFormDataDialogProps) => {
