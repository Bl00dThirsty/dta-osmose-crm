...
export function ChartAreaInteractive({ institutionSlug }: ChartAreaInteractiveProps) {
 ...
 React.useEffect(() => {
  ...
  if (!token) {
    console.warn("?? Token JWT manquant dans le localStorage.");
    return;
  }
  ...
  try {
    ...
    console.log("? Donn es dashboard:", response.data);
